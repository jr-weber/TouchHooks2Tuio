...
XmlReaderException::XmlReaderException( const QString & message,
...
QString XmlReaderException::getDocErrors()
{
    return docErrors_;
}

int XmlReaderException::getLineNumber()
{
    return lineNumber_;
}

int XmlReaderException::getColNumber()
{
    return colNumber_;
}

QString XmlReaderException::getXmlFilename()
{
    return xmlFilename_;
}
