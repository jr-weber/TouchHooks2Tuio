...
*/
#ifndef HOOKSEXCEPTIONS_TOUCHHOOKSEXCEPTION_H
#define HOOKSEXCEPTIONS_TOUCHHOOKSEXCEPTION_H

#include <QString>

namespace hooksExceptions
{
    class TouchHooksException
    {
        public:
            TouchHooksException( const QString & message, const QString & source );
            virtual ~TouchHooksException();
