...
Purpose: For reporting an error found when writing an XML configuration file.
*******************************************************************************/
/*
...
*/
#ifndef HOOKSEXCEPTIONS_XMLWRITEREXCEPTION_H
#define HOOKSEXCEPTIONS_XMLWRITEREXCEPTION_H
...
namespace hooksExceptions
{
    ...
    ***************************************************************************/
    class XmlWriterException : public IOException
    {
        public:
            XmlWriterException( const QString & message,
                                const QString & source,
                                const QString & xmlFilename );
            virtual ~XmlWriterException();
