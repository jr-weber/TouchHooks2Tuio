...
Superclass for all Input/Output exceptions.
*******************************************************************************/
/*
...
*/
#ifndef HOOKSEXCEPTIONS_IOEXCEPTION_H
#define HOOKSEXCEPTIONS_IOEXCEPTION_H

#include "hooksExceptions/TouchHooksException.h"

namespace hooksExceptions
{
    class IOException : public TouchHooksException
    {
        public:
            IOException( const QString & message, const QString & source );
            virtual ~IOException();
