...
namespace TUIO {
    ...
    public:
        ...
        /**
         * Sends a Flash XML TCP message.  Always adds a null character to the
         * end of the string before sending.
         *
         * @param  message  the Flash XML TUIO as a single long string.
         * @return true if the data was delivered successfully
         */
        bool sendFlashXmlMessage( std::string message );
    ...
    private:
        ...
        std::string partial_previous_message;
